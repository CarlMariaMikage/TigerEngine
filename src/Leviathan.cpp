...
const float Leviathan::ParticleSpread = 400.0f;

Leviathan::Leviathan(UINT width, UINT height, std::wstring name) :
...
void Leviathan::CreateVertexBuffer()
{
...
float Leviathan::RandomPercent()
{
    float ret = static_cast<float>((rand() % 10000) - 5000);
    return ret / 5000.0f;
}

void Leviathan::LoadParticles(_Out_writes_(numParticles) Particle* pParticles, const XMFLOAT3& center, const XMFLOAT4& velocity, float spread, UINT numParticles)
{
    srand(0);
...
void Leviathan::CreateParticleBuffers()
{
...
void Leviathan::CreateAsyncContexts()
{
...
void Leviathan::ReleaseD3DResources()
{
...
void Leviathan::RestoreD3DResources()
{
...
void Leviathan::PopulateCommandList()
{
...
DWORD Leviathan::AsyncComputeThreadProc(int threadIndex)
{
...
void Leviathan::Simulate(UINT threadIndex)
{
    ID3D12GraphicsCommandList* pCommandList = m_computeCommandList[threadIndex].Get();
...
void Leviathan::OnKeyDown(UINT8 key)
{
    m_camera.OnKeyDown(key);
}

void Leviathan::OnKeyUp(UINT8 key)
{
    m_camera.OnKeyUp(key);
}

void Leviathan::WaitForRenderContext()
{
...
void Leviathan::MoveToNextFrame()
{
